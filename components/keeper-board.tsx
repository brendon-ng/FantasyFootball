                      ...
                      >
                        ...
                        {adjustments.has(c.playerId) ? (
                          <Tip
                            ...
                            text={`${adjustments.get(c.playerId)}. Straight from the live league. Keeper contracts are rebuilt when the draft is archived, so a preseason move stays marked until then even though the transaction itself is committed within a day. The mark clears on its own once the two agree.`}
                          >
                            ●
                          </Tip>
                        ) : null}
